...
Теперь Васе интересно: как закодить функцию, определяющую, анаграммы слова или нет. Помогите ему.
...
word1_arr = list(input())
word2_arr = list(input())

word1_arr.sort()
word2_arr.sort()

print(word1_arr == word2_arr)
